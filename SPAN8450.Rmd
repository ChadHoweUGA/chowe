...
# articlechoice is now a data frame with columns named by the headers in the comma-separated-value (CSV) file
...
If you are using RStudio, examining articlechoice should look pretty similar to the spreadsheet in Figure 4.2 on Brezina (2018) page 105
...
The R table function creates a contingency able out of these two factor
...
-  **H0:** El tipo de artículo y el tipo de contexto son independientes.
-  **H1:** El tipo de artículo y el tipo de contexto no son independientes.
